...
void GenRescue::sendPath(std::vector<XYPoint> visit_points){
  ...
  Notify("SURVEY_UPDATE", update_string);
  cout << "notified updates_waypoint" << endl;
}

vector<XYPoint> GenRescue::generatePath(std::vector<XYPoint> visit_points){
...
double GenRescue::pythagorean(XYPoint a, XYPoint b){
